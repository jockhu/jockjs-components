...
(function (J) {
	...
	function Appdownload(options){
		...
		function creatContent(){
			...
			ms = "float: left;margin: 10px 8px 0 4px;width:59px; height:59px; background-size:59px 59px;background-image:url("+opts.img+")",
			ts = "float: left;width: 122px;margin-top: 10px;",
