...
;(function(win){
    ...
    Jock.map = {
        ...
        loadBaiduMap: function(object, callback){
            ...
            Jock.loadResource('js', 'http://api.map.baidu.com/getscript?v='+baiduApiVersion, this, function(){Jock.loadResource('js', Jock.baseDomain + 'api/map/b/' + this.version.baidu + '.js', object, callback);});
