...
//            });
    ...
    Jock.extend(fn,(function(){
        ...
        function localSearch(RouteOptions) {
            var local = new BMap.LocalSearch(map,{
                onSearchComplete: function(results){
                    ...
                    div.style.cssText = 'clear:both; height:244px; overflow-x:hidden; overflow-y:auto; padding:8px 0 0 8px; line-height:26px;';
        ...
        function getRouteDescription(RouteOptions, results, index, routeType){
            ...
            // 最外框
            var description = ['<div id="sec_result" style="clear:both; height:244px; overflow-x:hidden; overflow-y:auto; padding:8px 0 5px 6px; height:239px; *height:239px; font-size:12px;">'];
